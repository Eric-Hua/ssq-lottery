...
| 📋 备选池 | 收集心仪注数(最多 10 注),一键复制成文本去投注;顶部带 **1–33 红球覆盖图**,标注与近 6 期的关系(金圈=已开出、青圈=相邻) |
...
备选池顶部会把你所有已收藏注数的红球汇总成 **1–33 球网格**,并与**近 6 期**开奖号码对照:

| 标记 | 含义 |
| --- | --- |
| 实心红 | 该号码已出现在备选池的注数里(灰 = 未选) |
| 🟡 金圈 | 近 6 期已开出 |
| 🔵 青圈 | 与近 6 期开奖号码相邻(差 ±1) |
| 无标记 | 与近 6 期无关联 |

下方汇总“已覆盖 X/33 个号码”;鼠标悬停任一球可看到它在备选池中出现多少注。

> 用处:一眼看出你的号码是集中在近期热点区,还是散得很开 —— 便于手动补几个“热点邻近”的号。
