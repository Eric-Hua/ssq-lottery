...
| 🧮 号码区间对照 | 每行一张 1–33 网格:我的自选(可编辑/可隐藏)、最多 5 条推荐柱(可增删)、近 5 期开奖;带三区比 |
...
| 第 N 期 × 5 行 | 近 5 期开奖号码(最新在前) | — |

- 网格在 **11/12、22/23 之间留白**,直接看出一区(1–11)/ 二区(12–22)/ 三区(23–33)的分布
- 每行最右列为**三区比**(如 `2 : 3 : 1`),便于横向比对

> 用处:不用逐期翻历史,一眼看出自选/推荐号码与近期开奖的区间分布差多少 —— 比如近 5 期都是二区偏多,而你的号全挤在一区。
